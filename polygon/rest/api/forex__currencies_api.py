...
class ForexCurrenciesApi(object):
    ...
    def v1_conversion_from_to_get(self, _from, to, **kwargs):  # noqa: E501
        """Real-time Currency Conversion  # noqa: E501

        Convert currencies using the latest market conversion rates. Note than you can convert in both directions. For example USD->CAD or CAD->USD.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_conversion_from_to_get(_from, to, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str _from: From Symbol of the pair (required)
        :param str to: To Symbol of the pair (required)
        :param int amount: Amount we want to convert. With decimal
        :param int precision: Decimal precision of the conversion. Defaults to 2 which is 2 decimal places accuracy.
        :return: object
        ...
        if kwargs.get('async_req'):
            return self.v1_conversion_from_to_get_with_http_info(_from, to, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_conversion_from_to_get_with_http_info(_from, to, **kwargs)  # noqa: E501
            return data

    def v1_conversion_from_to_get_with_http_info(self, _from, to, **kwargs):  # noqa: E501
        """Real-time Currency Conversion  # noqa: E501

        Convert currencies using the latest market conversion rates. Note than you can convert in both directions. For example USD->CAD or CAD->USD.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_conversion_from_to_get_with_http_info(_from, to, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['_from', 'to', 'amount', 'precision']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method v1_conversion_from_to_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('_from' not in params or
            ...
            raise ValueError("Missing the required parameter `_from` when calling `v1_conversion_from_to_get`")  # noqa: E501
        # verify the required parameter 'to' is set
        if ('to' not in params or
                params['to'] is None):
            raise ValueError("Missing the required parameter `to` when calling `v1_conversion_from_to_get`")  # noqa: E501
    ...
    def v1_historic_forex_from_to_date_get(self, _from, to, _date, **kwargs):  # noqa: E501
        """Historic Forex Ticks  # noqa: E501

        Get historic ticks for a currency pair. Example for **USD/JPY** the from would be **USD** and to would be **JPY**. The date formatted like **2017-6-22**   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_historic_forex_from_to_date_get(_from, to, _date, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str _from: From Symbol of the currency pair (required)
        :param str to: To Symbol of the currency pair (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_historic_forex_from_to_date_get_with_http_info(_from, to, _date, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_historic_forex_from_to_date_get_with_http_info(_from, to, _date, **kwargs)  # noqa: E501
            return data

    def v1_historic_forex_from_to_date_get_with_http_info(self, _from, to, _date, **kwargs):  # noqa: E501
        """Historic Forex Ticks  # noqa: E501

        Get historic ticks for a currency pair. Example for **USD/JPY** the from would be **USD** and to would be **JPY**. The date formatted like **2017-6-22**   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_historic_forex_from_to_date_get_with_http_info(_from, to, _date, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_historic_forex_from_to_date_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter '_from' is set
        if ('_from' not in params or
                params['_from'] is None):
            raise ValueError("Missing the required parameter `_from` when calling `v1_historic_forex_from_to_date_get`")  # noqa: E501
        # verify the required parameter 'to' is set
        if ('to' not in params or
                params['to'] is None):
            raise ValueError("Missing the required parameter `to` when calling `v1_historic_forex_from_to_date_get`")  # noqa: E501
        # verify the required parameter '_date' is set
        if ('_date' not in params or
                params['_date'] is None):
            raise ValueError("Missing the required parameter `_date` when calling `v1_historic_forex_from_to_date_get`")  # noqa: E501
    ...
    def v1_last_quote_currencies_from_to_get(self, _from, to, **kwargs):  # noqa: E501
        """Last Quote for a Currency Pair  # noqa: E501

        Get Last Quote Tick for a Currency Pair.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_last_quote_currencies_from_to_get(_from, to, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_last_quote_currencies_from_to_get_with_http_info(_from, to, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_last_quote_currencies_from_to_get_with_http_info(_from, to, **kwargs)  # noqa: E501
            return data

    def v1_last_quote_currencies_from_to_get_with_http_info(self, _from, to, **kwargs):  # noqa: E501
        """Last Quote for a Currency Pair  # noqa: E501

        Get Last Quote Tick for a Currency Pair.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_last_quote_currencies_from_to_get_with_http_info(_from, to, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_last_quote_currencies_from_to_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter '_from' is set
        if ('_from' not in params or
                params['_from'] is None):
            raise ValueError("Missing the required parameter `_from` when calling `v1_last_quote_currencies_from_to_get`")  # noqa: E501
        # verify the required parameter 'to' is set
        if ('to' not in params or
                params['to'] is None):
            raise ValueError("Missing the required parameter `to` when calling `v1_last_quote_currencies_from_to_get`")  # noqa: E501
    ...
    def v2_snapshot_locale_global_markets_forex_direction_get(self, direction, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_snapshot_locale_global_markets_forex_direction_get(direction, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v2_snapshot_locale_global_markets_forex_direction_get_with_http_info(direction, **kwargs)  # noqa: E501
        else:
            (data) = self.v2_snapshot_locale_global_markets_forex_direction_get_with_http_info(direction, **kwargs)  # noqa: E501
            return data

    def v2_snapshot_locale_global_markets_forex_direction_get_with_http_info(self, direction, **kwargs):  # noqa: E501
        """Snapshot - Gainers / Losers  # noqa: E501

        See the current snapshot of the top 20 gainers or losers of the day at the moment.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_snapshot_locale_global_markets_forex_direction_get_with_http_info(direction, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_snapshot_locale_global_markets_forex_direction_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('direction' not in params or
            ...
            raise ValueError("Missing the required parameter `direction` when calling `v2_snapshot_locale_global_markets_forex_direction_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/snapshot/locale/global/markets/forex/{direction}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def v2_snapshot_locale_global_markets_forex_tickers_get(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_snapshot_locale_global_markets_forex_tickers_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v2_snapshot_locale_global_markets_forex_tickers_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.v2_snapshot_locale_global_markets_forex_tickers_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def v2_snapshot_locale_global_markets_forex_tickers_get_with_http_info(self, **kwargs):  # noqa: E501
        """Snapshot - All Tickers  # noqa: E501

        Snapshot allows you to see all tickers current minute aggregate, daily aggregate and last trade. As well as previous days aggregate and calculated change for today.  ### *** Warning, may cause browser to hang *** The response size is large, and sometimes will cause the browser prettyprint to crash.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v2_snapshot_locale_global_markets_forex_tickers_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v2_snapshot_locale_global_markets_forex_tickers_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/v2/snapshot/locale/global/markets/forex/tickers', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
