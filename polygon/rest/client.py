...
class RESTClient:
    ...
    def reference_stock_financials_vx(self, **query_params) -> models.ReferenceStockFinancialsVxApiResponse:
        endpoint = f"{self.url}/vX/reference/financials"
        return self._handle_response("ReferenceStockFinancialsVxApiResponse", endpoint, query_params)
